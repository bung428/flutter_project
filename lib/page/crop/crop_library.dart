...
class _CropState extends State<Crop> with TickerProviderStateMixin {
  ...
  void _reCenterImage([bool animate = true]) {
    ...
    print('KBG widget.controller._offset : ${widget.controller._offset}');
    ...
    print('KBG normalized : ${(bakedObb.topLeft - bakedObb.bottomLeft).normalized()}');
    ...
    print('KBG end?? _start : $_startOffset');
    print('KBG end?? _endOffset : $_endOffset');
    print('KBG end?? widget.controller._offset : ${widget.controller._offset}');
    ...
    Widget _buildInnerCanvas() {
      final ip = IgnorePointer(
        ...
        child: Transform(
          ...
          transform: Matrix4.identity()..translate(o.dx, o.dy, 0)
            ..rotateZ(r)
            ..scale(s, s, 1),
          child: FittedBox(
            child: widget.child,
